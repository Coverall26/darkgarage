...
describe("Data Migration E2E", () => {
  beforeEach(() => {
    jest.clearAllMocks();
    // Default: requireAdmin succeeds with admin context (Pages Router)
    ...
    // Default: requireAdminAppRouter succeeds with admin context (App Router)
  ...
  describe("Export Endpoint", () => {
    ...
    it("rejects non-admin users", async () => {
      // Export handler is App Router — override requireAdminAppRouter
      mockRequireAdminAppRouter.mockResolvedValue(
  ...
  describe("Import Endpoint", () => {
    ...
    it("rejects non-admin users", async () => {
      // Import handler is App Router — override requireAdminAppRouter
      mockRequireAdminAppRouter.mockResolvedValue(
        NextResponse.json({ error: "Forbidden" }, { status: 403 }),
      );
