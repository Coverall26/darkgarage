...
const mockRequireAdminAppRouter = jest.fn().mockResolvedValue({
  userId: "gp-user-1",
...
describe("Admin Fund Dashboard E2E", () => {
  ...
  describe("GP Access - Fund Dashboard", () => {
      ...
      const mockFunds = [
        {
          ...
          investments: [
            ...
            { investorId: "inv-2", commitmentAmount: 100000, fundedAmount: 50000 },
          ],
    ...
    it("GP with no teams sees empty dashboard", async () => {
      const { req, res } = createMocks({ method: "GET" });
  ...
  describe("LP Access Denied - Fund Dashboard", () => {
    it("LP cannot access admin fund dashboard", async () => {
      ...
      // Mock requireAdminAppRouter to reject LP user
      mockRequireAdminAppRouter.mockResolvedValue(
        NextResponse.json({ error: "You need to be a team member to access the fund dashboard" }, { status: 403 })
      );
  ...
  describe("Unauthenticated Access", () => {
    it("returns 401 when not authenticated", async () => {
      ...
      // Mock requireAdminAppRouter to reject unauthenticated user
      mockRequireAdminAppRouter.mockResolvedValue(
...
describe("Bulk Action E2E", () => {
  ...
  describe("LP Access Denied - Bulk Actions", () => {
    it("LP cannot perform bulk actions", async () => {
      ...
      // Mock requireAdminAppRouter to reject non-admin user
      mockRequireAdminAppRouter.mockResolvedValue(
