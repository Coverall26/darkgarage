...
/**
 * Error boundary for LP wire instructions page (/lp/wire).
 */
export default function WireError({
  error,
  reset,
}: {
    ...
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4">
      <div className="max-w-md w-full text-center">
        ...
        <h2 className="text-2xl font-semibold text-white mb-3">
          Wire Instructions Error
        </h2>
        <p className="text-gray-400 mb-2 text-sm">
          We couldn&apos;t load the wire transfer details.
          Please try again or contact your fund administrator.
        </p>
        {error.digest && (
