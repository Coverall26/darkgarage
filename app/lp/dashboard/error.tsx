...
/**
 * Error boundary for LP dashboard (/lp/dashboard).
 */
export default function LPDashboardError({
  error,
  reset,
}: {
    ...
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4">
      <div className="max-w-md w-full text-center">
        ...
        <p className="text-gray-400 mb-2 text-sm">
          We couldn&apos;t load your dashboard. Your investment data is safe.
