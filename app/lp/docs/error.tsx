...
/**
 * Error boundary for LP documents vault (/lp/docs).
 */
export default function LPDocsError({
  error,
  reset,
}: {
    ...
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4">
      <div className="max-w-md w-full text-center">
        ...
        <h2 className="text-2xl font-semibold text-white mb-3">
          Document Vault Error
        </h2>
        <p className="text-gray-400 mb-2 text-sm">
          We couldn&apos;t load your documents. Your files are safely stored
          and will be available when this issue is resolved.
        </p>
        {error.digest && (
