...
/**
 * Error boundary for investor pages (/admin/investors/*).
 * Catches render errors and provides recovery with investor-specific context.
 */
export default function InvestorsError({
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center bg-[#0A1628] px-4">
      <div className="max-w-md w-full text-center">
        ...
        <p className="text-gray-400 mb-2 text-sm">
          We couldn&apos;t load the investor information.
